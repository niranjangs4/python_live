...
def get_py_exec():
  ...
  live_logger.exec_script_str_local(request.query.user_script,
...
if __name__ == "__main__":
    #threading.Thread(run(host='localhost', port=8003, reloader=True)).start()
    threading.Thread(target=run, kwargs={'host':'localhost', 'port':8003, 'reloader':True}).start()


    os.system("start http://localhost:8003/python.html#mode=edit")
    os.system("start https://sites.google.com/view/learn-advance-python")
    os.system("start https://github.com/niranjangs4")
